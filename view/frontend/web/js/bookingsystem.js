...
define([
    ...
    $.widget("bookingsystem.bookingsystem", {
        ...
        _create: function () {
            ...
            var preventBookingBefore = self.options.prevent_booking_before;
            var currentDateData = "";
            ...
            $(document).ready(function () {
                ...
                $(document).on("click", ".mb-book-now", function () {
                    showPanel();
                    var d = new Date();
                            ...
                            function (k, v) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        if (
                                            !$(".booked-slot-summary").is(
                                                ":empty"
                                            )
                                        ) {
                                            $(
                                                ".booked-slot-summary .booked-short-history"
                                            ).remove();
                                            $("body")
                                                .find(
                                                    ".mb-slots-summary-wrapper"
                                                )
                                                .hide();
                                        }
                                        if (data.backUrl) {
                ...
                $(document).on("input", ".mb-qty", function (event) {
                    ...
                    if (qty == 0) {
                        ...
                        alert({
                            content: $t(
                                "Please enter a numeric value and is greater than 0"
                            ),
                        });
                    } else if (
                        cond &&
            ...
            function showPanel() {
                $(".mb-bg-container").fadeIn("slow");
                $(".mb-box-modal").animate({ "margin-top": "125px" }, 500);
            }

            function hidePanel() {
                $(".mb-bg-container").fadeOut("slow");
                $(".mb-box-modal").animate({ "margin-top": "-400px" }, 500);
            }
